      ...
      <view class="section-card">
        ...
        <view class="section-card__body">
          ...
          <view class="help-links">
            ...
            <view class="help-link" @tap="preview('weixin-chat-cl')">
              <u-icon name="chat" size="40" color="var(--u-type-success)" />

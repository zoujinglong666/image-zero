...
CREATE TABLE IF NOT EXISTS user_preferences (
    ...
    pref_value VARCHAR(4096) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS history (
    ...
    image_url     VARCHAR(500) DEFAULT ''                        COMMENT '原图URL/base64(缩略)',
    prompt_cn     VARCHAR(2000) DEFAULT ''                       COMMENT '中文提示词',
    prompt_en     VARCHAR(2000) DEFAULT ''                       COMMENT '英文提示词',
    style         VARCHAR(100) DEFAULT ''                       COMMENT '风格',
    result_json   TEXT                                     COMMENT '完整分析结果结果JSON',
